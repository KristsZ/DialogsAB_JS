...
//document.getElementById("array_find").innerHTML = "FIndex of first number over 18 is " + first;
//document.getElementById("array_find").innerHTML = "First (from end) number over 18 is " + first;
//document.getElementById("array_find").innerHTML = "Index of first (from end) number over 18" + first;
